# TinyMediaViewer
<p align="center">
  <img alt="TinyMediaViewer v0.5.2" src="https://img.shields.io/badge/TinyMediaViewer-v0.5.2-2d76ff?style=for-the-badge">
...
- **前端体验（Tiny Media Viewer）**：
  ...
  - 光标/特效：独角兽/心形光标；心跳线框 + 同步粒子爆点；媒体卡片心跳随色随机高亮。
